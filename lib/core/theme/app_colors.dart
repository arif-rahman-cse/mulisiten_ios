...
class AppColors {
  ...
  static const Color tempWarmStart = Color(
    0xFFFFE0B2,
  ...
  // Altitude tile gradient (teal → indigo)
  static const Color altitudeStart = Color(0xFFB2DFDB); // Colors.teal.shade100
  static const Color altitudeEnd = Color(0xFF7986CB); // Colors.indigo.shade300

  // Fall-safe tile gradient (green → emerald)
  static const Color fallSafeStart = Color(0xFFC8E6C9); // Colors.green.shade100
  static const Color fallSafeEnd = Color(0xFF66BB6A); // Colors.green.shade400

  // Battery tile gradient (blueGrey.shade100 → blueGrey.shade300)
  static const Color batteryStart = Color(
    0xFFCFD8DC,
  ); // Colors.blueGrey.shade100
  static const Color batteryEnd = Color(0xFF90A4AE); // Colors.blueGrey.shade300
